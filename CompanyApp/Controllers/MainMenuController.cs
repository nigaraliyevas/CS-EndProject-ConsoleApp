...
namespace CompanyApp.Controllers
{
    public class MainMenuController
    {
        public static void MainMenu() {
            ...
            #region loading-bar
            Helpers.ChangeTextColorForLoading(ConsoleColor.White, "                                               Loading");
            ...
            while (true)
            {
                ...
                if (menuBar && menuSelection > 0 && menuSelection < 3)
                {
                    switch (menuSelection)
                    {
                        ...
                        MenuDepartment: ChangeTextColor(ConsoleColor.White,
                        $"[{count += 1}] Create Department\n" +
                        $"[{count += 1}] Get All Departments\n" +
                        $"[{count += 1}] Get All Departments By Capacity\n" +
                        $"[{count += 1}] Get All Departments With Sorted Capacity\n" +
                            ...
                            if (getDepartmentMenu > 0 && getDepartmentMenu < 9)
                            {
                                switch (getDepartmentMenu)
                                {
                                    ...
                                    case (int)DepartmentMenu.GetAllDepartmentsByCapacity:
                                        ...
                                        break;
                                    case (int)DepartmentMenu.GetAllDepartmentsWithSortedCapacity:
                                        departmentController.GetAllDepartmentsWithSortedCapacity();
                                        break;
                        ...
                        case (int)Menus.EmployeeMenu:
                            MenuEmployee: ChangeTextColor(ConsoleColor.White,
                            $"[{count += 1}] Create Employee\n" +
                            $"[{count += 1}] Get All Employees\n" +
                            $"[{count += 1}] Get All Employees With Sorted Age\n" +
                            $"[{count += 1}] Get All Employees With Sorted Salary\n" +
                            ...
                            $"[{count += 1}] Old Datas Of Updated Employees\n" +
                            ...
                            if (getEmployeeMenu > 0 && getEmployeeMenu < 15)
                            {
                                switch (getEmployeeMenu)
                                {
                                    ...
                                    case (int)EmployeeMenu.GetAllEmployees:
                                        ...
                                        break;
                                    case (int)EmployeeMenu.GetAllEmployeesWithSortedAge:
                                        employeeController.GetAllEmployeesWithSortedAge();
                                        break;
                                    case (int)EmployeeMenu.GetAllEmployeesWithSortedSalary:
                                        employeeController.GetAllEmployeesWithSortedSalary();
                                        break;
                                    ...
                                    case (int)EmployeeMenu.UpdateEmployee:
                                        ...
                                        break;
                                    case (int)EmployeeMenu.OldDatasOfUpdatedEmployees:
                                        employeeController.OldDatasOfUpdatedEmployees();
                                        break;
